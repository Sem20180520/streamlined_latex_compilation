...
\begin{align*}
   ...
   \right\}\\
   =\frac{1}{n}&\left\{ \log|\alpha|+\log\left|\frac{\alpha+1}{2}\right|+\dots+\log\left|\frac{\alpha}{n}+\frac{n-1}{n}\right|
   +\log\left|\frac{\beta}{\gamma}\right|
   +\log\left|\frac{\beta+n-1}{\gamma+n-1}\right|\right\}\\
   &\overset{n\longrightarrow\infty}{\longrightarrow}0
\end{align*}
よって、
$\lim_{n\to\infty}|c_n|^\frac{1}{n}=1$
となり、収束半径は1であることが分かる。
